    ...
    class Ninja_WCCart
    {
        public function __construct()
        {
            ...
            if ( defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '2.3', '>=' ) ) {
                add_filter( 'woocommerce_add_to_cart_fragments', array( $this, 'ninja_cart_link_fragment' ) );
            } else {
                add_filter( 'add_to_cart_fragments', array( $this, 'ninja_cart_link_fragment' ) );
            }
        }
